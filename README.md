...
[Website](https://animeshsingh.in/StateMover/) · [Guide](https://animeshsingh.in/StateMover/guide.html) · [Install](#install) · [Snapshot format](#snapshot-format) · [Build](#build-from-source)
...
The project site has a longer [usage guide](https://animeshsingh.in/StateMover/guide.html), the
[privacy policy](https://animeshsingh.in/StateMover/privacy.html) and the [terms](https://animeshsingh.in/StateMover/terms.html).
...
access. Nothing leaves your machine - see the [privacy policy](https://animeshsingh.in/StateMover/privacy.html).
